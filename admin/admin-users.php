...
?>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card my-2 border-success">
				...
				<div class="card-body">
					<div class="table-responsive mt-3" id="showAllUsers">
	...
	<!---- Display User's in Details Modal Start----->
	...
	<!---- Display User's in Details Modal End----->
				...
				$.ajax({
					...
					success:function(response){
						...
						if (data.photo != ''){
							...
							$("#getImage").html('<img src="../assets/Img/DefaultUser.jpg" class="img-thumbnail img-fluid align-self-center" width="280px">');
						}
					}
				});
			});
